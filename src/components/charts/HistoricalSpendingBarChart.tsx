    ...
    <div className="space-y-4">
      ...
      <div className="rounded-[32px] border border-dashed border-gray-200 bg-gray-50/50 p-6">
        ...
        {hasData ? (
          ...
          <div className="flex h-64 items-center justify-center rounded-[24px] border border-dashed border-gray-200 bg-white/40 text-center">
            <div>
              <p className="text-sm font-black text-gray-700">
                No monthly spending history available
              </p>
              <p className="mt-2 text-xs text-gray-400">
                Add expense transactions across a few months to populate this chart.
              </p>
            </div>
          </div>
        )}
