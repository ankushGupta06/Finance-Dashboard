  ...
  return (
    <>
      ...
      <button 
        ...
        className="lg:hidden fixed top-6 left-6 z-50 p-3 bg-blue-600 text-white rounded-2xl shadow-xl hover:bg-blue-700 transition-all"
      >
      ...
      <aside 
        className={`
          ...
          bg-white flex flex-col justify-between p-6 border-r border-gray-100
      ...
      >
        <div className="relative">
          ...
          <div className={`flex items-center justify-between mb-12 px-1`}>
            ...
            <button 
              ...
              className="hidden lg:flex items-center justify-center h-8 w-8 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all"
            >
              <ChevronLeft 
        ...
        <div className="flex flex-col gap-4">
          {!isCollapsed ? (
            <div className="bg-amber-400 rounded-[32px] p-6 text-white text-center flex flex-col items-center gap-4 relative overflow-hidden shadow-xl shadow-amber-100">
              ...
              <button className="bg-white text-amber-500 hover:bg-gray-50 transition-colors w-full py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest">
                Upgrade Now &rarr;
              </button>
            </div>
          ) : (
