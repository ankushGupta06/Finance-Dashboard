    ...
    <div className="relative group mb-10">
      ...
      <div className="flex items-center justify-between mb-6 pr-4">
        <div className="flex items-center gap-3">
          <h2 className="text-xl font-black text-gray-800 tracking-tight">Goals</h2>
        ...
        <button className="text-blue-500 hover:bg-blue-50 p-1.5 rounded-full transition-colors bg-white shadow-sm border border-gray-50">
      ...
      <div className="flex gap-5 overflow-x-auto pb-4 no-scrollbar scroll-smooth">
        ...
        <div className="min-w-[100px] flex flex-col items-center justify-center border-2 border-dashed border-gray-100 rounded-[32px] text-gray-300 hover:text-gray-400 hover:border-gray-200 cursor-pointer transition-all">
          <Plus size={24} />
